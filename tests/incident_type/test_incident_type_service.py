def test_get(session, incident_type):
    from dispatch.incident_type import get
...
def test_get_by_name(session, incident_type):
    from dispatch.incident_type import get_by_name
...
def test_get_by_slug(session, incident_type):
    from dispatch.incident_type import get_by_slug
...
def test_get_all(session, incident_types):
    from dispatch.incident_type import get_all
...
def test_create(session):
    from dispatch.incident_type import create
    from dispatch.incident_type import IncidentTypeCreate
...
def test_delete(session, incident_type):
    from dispatch.incident_type import delete, get
