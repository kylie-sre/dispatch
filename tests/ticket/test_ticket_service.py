def test_get_ticket(session, ticket):
    from dispatch.ticket import get
...
def test_get_by_resource_id(session, ticket):
    from dispatch.ticket import get_by_resource_id
...
def test_get_by_resource_type(session, ticket):
    from dispatch.ticket import get_by_resource_type
...
def test_get_all(session, tickets):
    from dispatch.ticket import get_all
...
def test_create(session, incident_type, incident_priority, individual_contact):
    from dispatch.ticket import create
